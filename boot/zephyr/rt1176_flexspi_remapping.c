...
__attribute__((section(".itcm"))) void rt1176_flexspi_remap_configure(const struct rt1176_flexspi_remap_config *config)
{
...
__attribute__((section(".itcm"))) void rt1176_flexspi_remap_enable(void)
{
...
__attribute__((section(".itcm"))) void rt1176_flexspi_remap_disable(void)
{
...
__attribute__((section(".itcm"))) bool rt1176_flexspi_is_remapping_enabled(void)
{
...
__attribute__((section(".itcm"))) static void invalidate_data_cache(void)
{
...
__attribute__((section(".itcm"))) static void invalidate_prefetch_buffer(void)
{
